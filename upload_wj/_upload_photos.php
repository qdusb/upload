<?php if (count($medias) == 0):?>
  <div class="b2 mt35 mar3 ui-sortable" style="padding: 20px 0 20px;" id="no_photo_tip">
  	<p class="cor_4 fz14 mo tac">您还没有商品图片哦，上传图片有利于客户对商品有直观体验</p>
...
<?php endif;?>
  ...
  <div class="<?php echo count($medias)?"":"dn";?>" id="photo_list" style="width: 720px; height: 100%; overflow:hidden;">
      ...
      <dl class="b1 pic_tag mt20 afei ml10" id="upload_more_photo" style="cursor: pointer;height: 155px;" onclick="pop_upload_pic();">
    		<dt class="tac pt30 mt10"><i class="pic_tag_bg"></i></dt>
    		<dd class="tac mt10"><a href="javascript:;" title="" class="cor_2 fz14">继续添加图片</a></dd>
  	  </dl>
  	  
  	</div>
	</div>
   <?php
  $url=sfConfig::get("site_url").myShop::getAjaxUrl("uploadProductPic","");
  ...
  ?>
	<div class="upload_pic_photo wrap_out" style="position: absolute; top: -5000px; width: 442px; visibility:hidden;">
		...
		<div class="wrap_bar" onselectstart="return false;"><div class="wrap_title"><span>商品图片上传</span></div>
      ...
      <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="442" height="330" id="update" align="middle">
  	  ...
  	  <div style="position:absolute;left:8px;bottom:8px;width:97%;height:16px;background:#DBE5F1;"></div>
  	  </div>
	  </div>
	  </div>
	</div>
<input type="hidden" id="delImgs" name='delImgs' />
...
var requestUploadUrl = "<?php echo myShop::getAjaxUrl("uploadProductPic", 0)."&sid=".session_id();?>";
</script>
...
function challs_flash_maxFile(a){//a本次上传的文件数
 ...
 function challs_flash_onCompleteAll(a){ //上传文件列表全部上传完毕事件,参数 a 数值类型，返回上传失败的数量
   ...
   hide_upload_pic();
   $("#no_photo_tip").hide();
   $("#tr_upload_pic").find(".Validform_checktip").hide();
